...
# Hardcoded subcategory URLs for Electronics Group 1
SUBCATEGORY_URLS = [
    # --- merged from original sub1 ---
    "https://www.boutiqaat.com/ar-kw/women/electronics/power-banks-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/chargers-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/cables-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/adapters-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/screen-protectors-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/phone-cases-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/phone-accessories-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/airpods-airtag-case-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/wallet-grips-stands/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/tablet-accessories/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/car-mount-1/l/",
    # --- merged from original sub2 ---
    "https://www.boutiqaat.com/ar-kw/women/electronics/car-charger-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/car-accessories-1312376319/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/bike-accessories-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/jump-starter-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/microphones-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/headphones-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/earphones-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/accessories-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/tv-projector-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/electronics/speakers-1/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/electronics/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/electronics/excel-files"
            )
